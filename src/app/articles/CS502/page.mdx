...
export const article = {
  author: 'Aoibheann Fegan',
  date: '2023-09-10',
  title: 'Harvard University: CS50 Web Programming with Python and Javascript',
  certificationURL:'https://www.dropbox.com/scl/fi/l8xxm9qc3hdkwcimzjeun/CS50-Web-Cert.png?rlkey=j87tr58zqx8aujbzrfmha24vk&dl=0',
  description:
    'I delved into the intricacies of crafting modern web applications. Through hands-on projects, I honed my skills in Python and JavaScript, mastering frameworks like Django. I also learned to design intuitive user interfaces, manage databases efficiently, and harness APIs, equipping me to build dynamic, scalable web applications.',
}
