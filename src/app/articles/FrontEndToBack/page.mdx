...
export const article = {
  ...
  date: '2024-01-24',
  title: 'Codecademy: Connecting Front-End to Back-End',
  certificationURL:'https://www.dropbox.com/scl/fi/sztj4m4z2sexf2uux4xpw/Codecademy-Connecting-Front-End-and-Back-End-2024-2.pdf?rlkey=chzt7285t4cehhk7igcwjmi1h&dl=0',
  description:
    'Connected the front-end and back-end by creating REST APIs and using the MVC architecture.',
}
