...
export const article = {
  ...
  date: '2024-01-17',
  title: 'Codecademy: Design Principles',
  certificationURL:'https://www.dropbox.com/scl/fi/f8lzq6ufepx284aomcg60/Codecademy-Software-Design-Principles-2024-1.pdf?rlkey=xdop0vdef9vmj8x86fkvm6cnv&dl=0',
  description:
    'Focused on building more complex systems with techniques such as design patterns, SOLID principles, and UML.',
}
