...
export const article = {
  ...
  certificationURL:'https://www.dropbox.com/scl/fi/m4qosxhrqw2lgcugivubm/CS50-Certificate-PNG.png?rlkey=xo6j67852ukexu6sqoizu3bmw&dl=0',
  description:
    'An introduction the foundational concepts of computer science. Covering algorithms, data structures, software engineering, and web development, it employs languages like C, Python, and SQL, plus HTML, CSS, and JavaScript. The course emphasizes problem-solving and the art of programming, providing a robust entry into the world of computing.',
}
