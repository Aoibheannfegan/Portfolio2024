...
export const article = {
  ...
  certificationURL:'https://www.dropbox.com/scl/fi/7hgnm718tpsr0t1kwvg2x/Codecademy-Learn-React-2024-1.pdf?rlkey=oqsbk0ow6v65mfh7h5h3hjjsu&dl=0',
  description:
    'Mastered the art of building dynamic user interfaces, managing component state, and utilizing hooks effectively. The course also emphasized the importance of props, lifecycle methods, and routing, equipping me with the expertise to create responsive and scalable single-page applications.',
}
