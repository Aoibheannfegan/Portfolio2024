...
import logoTallGrass from '@/images/logos/TallGrass.png'
import logoWa2 from '@/images/logos/wa2.webp'
...
function Article({ article }) {
  return (
    <Card as="article">
      <Card.Title href={article.certificationURL} target="_blank" >
        {article.title}
      </Card.Title>
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink 
              href="https://twitter.com/aoibheann_fegan" 
              aria-label="Follow on X" 
              icon={XIcon} 
            />
            <SocialLink
              href="https://github.com/Aoibheannfegan"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/aoibheann-fegan-1a8b80127/"
